...
MCP stdio server wrapping `@ai-native-solutions/falldental-sdk`.

## Install
```bash
claude mcp add falldental -- npx -y @ai-native-solutions/falldental-mcp
```
...
- **Discoverable** — indexed on the FallMarket catalog at [sjgant80-hub.github.io/fallmarket/listing.html?id=falldental-mcp](https://sjgant80-hub.github.io/fallmarket/listing.html?id=falldental-mcp)
...
- **Companion SDK** (`npm install @ai-native-solutions/falldental-mcp-sdk`) — programmatic JavaScript API for direct integration.
- **Companion MCP server** (`claude mcp add falldental-mcp -- npx -y @ai-native-solutions/falldental-mcp-mcp`) — Model Context Protocol server that any Claude/Cursor/Codex client can invoke as a tool.
- **Companion HTTP API** (`docker run --rm ghcr.io/sjgant80-hub/falldental-mcp-api`) — containerized REST endpoint for language-agnostic access.
...
- **Registry entry**: https://sjgant80-hub.github.io/fallmarket/listing.html?id=falldental-mcp
- **Live URL**: https://sjgant80-hub.github.io/falldental-mcp/
- **Source**: https://github.com/sjgant80-hub/falldental-mcp
